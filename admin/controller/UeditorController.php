...
class UeditorController extends UserBaseController
{
    ...
    protected function getConfig()
    {
        $config = '{
               ...
               "imagePathFormat": "/'. C('UPLOAD_DIR').'/{md5}",
                ...
                /*"scrawlPathFormat": "/ueditor/php/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}",*/ /* 上传保存路径,可以自定义保存路径和文件名格式 */
                 "scrawlPathFormat": "/'. C('UPLOAD_DIR').'/{md5}",
                ...
                /*"snapscreenPathFormat": "/ueditor/php/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}",*/ /* 上传保存路径,可以自定义保存路径和文件名格式 */
                 "snapscreenPathFormat": "/'. C('UPLOAD_DIR').'/{md5}",
                ...
                /*"catcherPathFormat": "/ueditor/php/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}",*/ /* 上传保存路径,可以自定义保存路径和文件名格式 */
                  "catcherPathFormat": "/'. C('UPLOAD_DIR').'/{md5}",
               ...
               /* "videoPathFormat": "/ueditor/php/upload/video/{yyyy}{mm}{dd}/{time}{rand:6}",*/ /* 上传保存路径,可以自定义保存路径和文件名格式 */
                 "videoPathFormat": "/'. C('UPLOAD_DIR').'/{md5}",
               ...
               /* "filePathFormat": "/ueditor/php/upload/file/{yyyy}{mm}{dd}/{time}{rand:6}", *//* 上传保存路径,可以自定义保存路径和文件名格式 */
                 "filePathFormat": "/'. C('UPLOAD_DIR').'/{md5}",
                ...
                /*"imageManagerListPath": "/ueditor/php/upload/image/",*/ /* 指定要列出图片的目录 */
                 "imageManagerListPath": "/'. C('UPLOAD_DIR').'/",
                ...
                /*"fileManagerListPath": "/ueditor/php/upload/file/",*/ /* 指定要列出文件的目录 */
                    "fileManagerListPath": "/'. C('UPLOAD_DIR').'/",
