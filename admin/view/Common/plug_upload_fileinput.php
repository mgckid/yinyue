    <!--上传插件 开始-->
    <link rel="stylesheet" href="/static/common/bootstrap-fileinput/css/fileinput.css">
    <script src="/static/common/bootstrap-fileinput/js/fileinput.js"></script>
    <script src="/static/common/bootstrap-fileinput/themes/fa/theme.js"></script>
    <script src="/static/common/bootstrap-fileinput/js/locales/zh.js"></script>
    <script>
        function fileInput(uploadId, inputName) {
            /**上传组件 配置 开始**/
            var config = {};
            config.language = 'zh';                                             //语言
            config.uploadUrl = '<?=U('Upload/index')?>';                  //服务端上传链接
            ...
            config.deleteUrl = '<?=U('Upload/deleteFile')?>';             //服务端删除操作链接
            /**上传组件 配置 结束**/
