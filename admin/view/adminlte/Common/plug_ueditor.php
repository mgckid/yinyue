...
<script type="text/javascript" charset="utf-8" src="/static/common/ueditor/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" charset="utf-8" src="/static/common/ueditor/ueditor.parse.js"></script>
<script>
    function ueditor(contentBox){
        uParse(contentBox, {
            rootPath: '/static/common/ueditor/'
        });
        //实例化编辑器
