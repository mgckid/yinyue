...
{
    if ($configName) {
        return \houduanniu\base\Application::getInstance()->register->get('config')->get($configName);
    } else {
        return \houduanniu\base\Application::getInstance()->register->get('config')->all();
    }
}
